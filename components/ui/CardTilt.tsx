...
const CardTilt : React.FC<Props> = ({children}) => {
  ...
  return (
    <>
      <div
        className='card relative h-[50vh] w-[50vw] transition-[all_400ms_cubic-bezier(0.03,0.98,0.52,0.99)_0s] will-change-transform'
