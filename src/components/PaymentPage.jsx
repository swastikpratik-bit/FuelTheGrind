...
const PaymentPage = ({ username }) => {
    ...
    const pay = async (amount) => {
        ...
        var options = {
            ...
            "currency": "INR",
            "name": "Fuel The Grind", //your business name
            "description": "Fuel the grind of " + username,
                            ...
                            <ul className='mx-5 text-lg'>
                                ...
                                {payments.slice(0, 7).map((p, i) => {
                                    return <li key={i} className='my-4 flex gap-2 items-center'>
                                        ...
                                        <span>
                                           <span className='font-bold'>{p.name.toUpperCase()}</span> donated <span className='font-bold'>₹{p.amount}</span> with a message &quot;{p.message}&quot;
                                        </span>
                                    </li>
                                })}
